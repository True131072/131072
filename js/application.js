...
function normalWin(merged) {
  return merged === 9007199254740992;
}

function normal() {
  changeRule(normalAdd, 
    function(a, b) { return a === b; }, 
    function(merged) { return merged === 8589934592; });
}
...
function mergeAny() {
  changeRule(function() { return Math.random() < 0.5 ? 16 : 32; },
...
function tileZero() {
  changeRule(function() {
    return Math.random() < 0.7 ? (Math.random() < 0.5 ? 4 : 8) : 0;
  }, normalMerge, normalWin);
}

function tileNegative() {
  changeRule(function() { return Math.random() < 0.5 ? 8 : -8; }, 
...
function gravity() {
  changeRule(normalAdd, 
    function(a, b) { return a === b; }, 
    function(merged) { return merged === 4294967296; });
