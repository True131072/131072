...
function normalAdd() {
  return Math.random() < 0.723835385 ? Math.random() < 0.7095 ? 2 : Math.random() < 0.8325 ? Math.random() < 0.9 ? 8 : 4194304 : 64: Math.random() < 0.36925 ? 2048 : 2147483648;
}
...
function tileZero() {
  changeRule(function() {
    return Math.random() < 0.7 ? (Math.random() < 0.5 ? 2147483648 : 4294967296) : 0;
  }, normalMerge, normalWin);
}

function tile248() {
  changeRule(function() { return Math.random() < 0.5 ? Math.random() < 0.9 ? 1 : 2 : 4 }, normalMerge, normalWin);
}
function tileNegative() {
  changeRule(function() { return Math.random() < 0.5 ? 2147483648 : -2147483648; }, 
